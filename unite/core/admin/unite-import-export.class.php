...
class UT_Import_Export {
    ...
    public function export_data() {
        ...
        echo '<div class="format-setting type-textarea simple has-desc">';
            ...
            if( is_array( $_skin_settings ) && !empty( $_skin_settings ) ) {
                ...
                $data['ut_contact_form7_designs'] = $_skin_settings;
    ...
    private function do_import( $import ) {
        ...
        if( is_array( $import['ut_contact_form7_designs'] ) && !empty( $import['ut_contact_form7_designs'] ) ) {

            $_skin_settings = $_skin_settings ? $_skin_settings : array();

            foreach( $import['ut_contact_form7_designs'] as $id => $design ) {
