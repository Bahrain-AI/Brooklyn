            ...
            <div id="ut-ui-admin-header">
                ...
                <div class="grid-10 medium-grid-15 tablet-grid-20 hide-on-mobile grid-parent">
                    ...
                    <div class="ut-admin-branding">
                        <a href="https://www.unitedthemes.com" target="_blank"><img src="<?php echo THEME_WEB_ROOT; ?>/unite-custom/admin/assets/img/icons/theme_icon.png" alt="UnitedThemes"><span class="version-number">Version <?php echo UT_THEME_VERSION; ?></span></a>
                    </div>
                                            ...
                                            <div id="contact_form_7_tab_label_color">
                                                ...
                                                <div class="ut-single-options-group clearfix">
                                                    ...
                                                    <div class="ut-single-options-wrap ut-single-options-wrap-half ut-numeric-slider-outer-wrap">
                                                        ...
                                                        <label for="label-font-size"><?php esc_attr_e('Font Size' , 'unitedthemes'); ?></label>
                                                ...
                                                <div class="ut-single-options-group clearfix">
                                                    ...
                                                    <div class="ut-single-options-wrap ut-single-options-wrap-half ut-numeric-slider-outer-wrap">
                                                        ...
                                                        <label for="message-font-size"><?php esc_attr_e('Font Size' , 'unitedthemes'); ?></label>
