...
class UT_Theme_Info {
     ...
     * @var string
     */
    protected $dashboard_notification = false;
    ...
    public function __construct() {
        ...
        /* knowledgebase */
        $this->knowledgebase = esc_url( 'https://knowledgebase.unitedthemes.com/' );
    ...
    function get_memory_limit() {
        ...
        if( $this->memory_limit ) {
            ...
            if( $this->memory_limit < 96 ) {
                ...
                /* show notification */
                $this->dashboard_notification = true;
    ...
    function dashboard_notification() {
        ...
        if( $this->dashboard_notification ) {

            if( get_option('hide_unite_health_dashboard_notification') ) {

                $class = 'notice notice-warning unite-health-status ut-hide';
            ...
            $dismiss = '<button type="button" class="notice-dismiss vc-notice-dismiss"><span class="screen-reader-text">' . __( 'Dismiss this notice.', 'unitedthemes' ) . '</span></button>';

            printf( '<div class="%1$s"><p>%2$s %3$s %4$s</p></div>', $class, $message, $link, $dismiss );
