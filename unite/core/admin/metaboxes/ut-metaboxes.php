        ...
        $settings = apply_filters( 'ut_bklyn_metabox_settings', array(
            ...
            'fields' => array(
                ...
                */
                ...
                array(
		            'id' => 'ut_page_video_filter_settings_headline',
		            'metapanel' => 'ut-hero-video-filters',
		            'label' => 'Video Filter Settings',
		            'type' => 'section_headline',
		            'pages' => $post_type_support_2,
		            'required' => array(
			            'ut_activate_page_hero' => 'on',
	            ...
	            array(
		            'id' => 'ut_page_video_filter',
		            'metapanel' => 'ut-hero-video-filters',
		            'label' => 'Add Video Filters?',
		            'desc' => sprintf( 'Except for IE that will not render CSS filters. For filter inspirations, please visit <a href="%s" target="_blank">cssfilters.co</a>. You can set a blend mode in Styling > Overlay.', 'https://www.cssfilters.co/' ),
		            'type' => 'select',
		            'choices' => array(
			            array(
				            'value' => 'no',
	            ...
	            array(
		            'id' => 'ut_page_video_filter_contrast',
		            'metapanel' => 'ut-hero-video-filters',
		            'label' => 'Contrast',
		            'desc' => '0% will make the video completely black. 100% is default and represents the original video. Values over 100% will provide results with less contrast.',
		            'type' => 'numeric-slider',
		            'std' => '100',
		            ...
		            'required' => array(
			            ...
			            'ut_page_hero_type' => 'video',
			            'ut_page_video_source' => 'selfhosted',
			            'ut_page_video_filter' => 'yes',
		            ),
	            ),
	            array(
		            'id' => 'ut_page_video_filter_brightness',
		            'metapanel' => 'ut-hero-video-filters',
		            'label' => 'Brightness',
		            'desc' => '0% will make the video completely black. 100% (1) is default and represents the original video. Values over 100% will provide brighter results.',
		            'type' => 'numeric-slider',
		            'std' => '100',
		            'min_max_step' => '0,200,1',
		            'pages' => $post_type_support_2,
	            ...
	            array(
		            'id' => 'ut_page_video_filter_saturate',
		            'metapanel' => 'ut-hero-video-filters',
		            'label' => 'Saturate',
		            'desc' => '0% (0) will make the video completely un-saturated. 100% is default and represents the original video. Values over 100% provides super-saturated results.',
		            'type' => 'numeric-slider',
		            'std' => '100',
		            'min_max_step' => '0,200,1',
		            'pages' => $post_type_support_2,
	            ...
	            array(
		            'id' => 'ut_page_video_filter_sepia',
		            'metapanel' => 'ut-hero-video-filters',
		            'label' => 'Sepia',
		            'desc' => '0% (0) is default and represents the original video. 100% will make the video completely sepia.',
		            'type' => 'numeric-slider',
		            'std' => '0',
		            'min_max_step' => '0,100,1',
		            'pages' => $post_type_support_2,
	            ...
	            array(
		            'id' => 'ut_page_video_filter_grayscale',
		            'metapanel' => 'ut-hero-video-filters',
		            'label' => 'Grayscale',
		            'desc' => '0% (0) is default and represents the original video. 100% will make the video completely gray.',
		            'type' => 'numeric-slider',
		            'std' => '0',
		            'min_max_step' => '0,100,1',
		            'pages' => $post_type_support_2,
	            ...
	            array(
		            'id' => 'ut_page_video_filter_invert',
		            'metapanel' => 'ut-hero-video-filters',
		            'label' => 'Invert',
	            ...
	            array(
		            'id' => 'ut_page_video_filter_hue',
		            'metapanel' => 'ut-hero-video-filters',
		            'label' => 'Hue Rotate',
		            'desc' => 'Applies a hue effect to the video.',
		            'type' => 'numeric-slider',
		            'std' => '0',
		            'min_max_step' => '0,360,1',
		            'pages' => $post_type_support_2,
		            'required' => array(
			            'ut_activate_page_hero' => 'on',
			            'ut_page_hero_type' => 'video',
	            ...
	            array(
		            'id' => 'ut_page_video_filter_blur',
		            'metapanel' => 'ut-hero-video-filters',
		            'label' => 'Blur',
		            'desc' => 'Applies a blur effect to the video. A larger value will create more blur. Note that this value is a pixel value. Due to the nature of blur filters the video will be zoomed slightly.',
		            'type' => 'numeric-slider',
		            'std' => '0',
		            'min_max_step' => '0,100,1',
		            'pages' => $post_type_support_2,
                ...
                array(
                    ...
                    'choices' => array(
                        array(
                            'value' => 'dots',
                            'label' => 'Connecting Dots (transparent)'
                        ),
                        array(
                            'value' => 'bubbles',
                            'label' => 'Rising Bubbles (transparent)'
                        ),
                        array(
                            'value' => 'aurora',
                            'label' => 'Aurora (not transparent)'
                        ),
                        array(
                            'value' => 'pipeline',
                            'label' => 'Pipeline (not transparent)'
                        ),
                        array(
                            'value' => 'swirl',
                            'label' => 'Swirl (transparent)'
                        ),
                        array(
                            'value' => 'shift',
                            'label' => 'Shift (not transparent)'
                        ),
                        array(
                            'value' => 'coalesce',
                            'label' => 'Coalesce (not transparent)'
                        ),
                ...
                array(
                    'id' => 'ut_page_hero_overlay_effect_background_color',
                    'metapanel' => 'ut-hero-styling-overlay-settings',
                    'label' => 'Overlay Effect Background Color',
                    'desc' => '<strong>(optional)</strong>. Default Colors is black.',
                    'type' => 'colorpicker',
                    'std' => ot_get_option( 'ut_global_hero_overlay_effect_color' ),
                    'required' => array(
                        'ut_page_hero_overlay_effect' => 'on',
                        'ut_page_hero_overlay_effect_global_overwrite' => 'off',
                        'ut_page_hero_overlay_effect_style' => 'pipeline|coalesce|shift',
                        'ut_page_hero_type' => 'image|animatedimage|imagefader|splithero|tabs|video|slider',
                    ),
                    'pages' => $post_type_support_2,
                ),
                ...
                array(
                    'id' => 'ut_page_hero_overlay_effect_color_range',
                    'metapanel' => 'ut-hero-styling-overlay-settings',
                    'label' => 'Color Range',
                    'desc' => 'The higher the range, the larger the amount of colors generated based on its base color.',
                    'type' => 'numeric-slider',
                    ...
                    'required' => array(
                        'ut_page_hero_overlay_effect' => 'on',
                        'ut_page_hero_overlay_effect_global_overwrite' => 'off',
                        'ut_page_hero_overlay_effect_style' => 'pipeline|coalesce|shift|swirl|aurora',
                        'ut_page_hero_type' => 'image|animatedimage|imagefader|splithero|tabs|video|slider',
                    ),
                    'pages' => $post_type_support_2,
                ),
				...
				*/
                ...
                array(
                    'id' => 'ut_section_scroll_settings',
                    'metapanel' => 'ut-section-scroll-settings',
                    'label' => 'Section Scroll Settings',
                    'type' => 'panel_headline',
                    'pages' => $post_type_support_2,
                ),

                array(
                    'id' => 'ut_activate_section_scroll',
                    'metapanel' => 'ut-section-scroll-settings',
                    'label' => 'Activate Section Scroll?',
                    'desc' => '',
                    'type' => 'select',
                    'std' => 'global',
                    'choices' => array(
