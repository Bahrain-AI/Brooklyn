...
function _ut_typography_settings( $font_settings, $field_id ){
    ...
    if( $field_id == 'ut_background_text_websafe_font_style' || $field_id == 'ut_background_text_custom_font_style' || $field_id == 'ut_background_text_google_font_style' ) {

        $font_settings = array_diff(  $font_settings, array( 'text-decoration', 'line-height' ) );
...
function _ut_typography_dynamic_max_font_sizes_in_px( $font_size, $field_id ){
    ...
    // background text
    if( $field_id == 'ut_background_text_google_font_style-font-size_unit' ||
        $field_id == 'ut_background_text_websafe_font_style-size_unit' ||
        $field_id == 'ut_background_text_custom_font_style-font-size_unit' ) {
    ...
    // background text
    if( $field_id == 'background_text_bklyn_background_text_font_size' ) {
...
function _ut_typography_dynamic_max_font_sizes_in_vh( $font_size, $field_id ){
    ...
    // section title
    if( $field_id == 'ut_global_google_headline_font_style-font-size_unit' ||
        $field_id == 'ut_global_headline_websafe_font_style-font-size_unit' ||
        $field_id == 'ut_global_headline_custom_font_style-font-size_unit' ) {
...
function _ut_button_builder_fields( $field, $field_id ){
    ...
    if( $field_id == 'submit_button' ) {

        $field = array_diff(  $field, array( 'hover-effect', 'effect-settings', 'icon-settings' ) );
