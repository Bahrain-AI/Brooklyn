...
function _ut_theme_options_onepage( $base_settings ) {
    ...
    $base_settings['settings'] = array_merge( $base_settings['settings'], array(
        ...
        */
        ...
        array(
            'id'          => 'ut_blog_overlay_effect_background_color',
            'label'       => 'Overlay Effect Background Color',
            'desc'        => '<strong>(optional)</strong>. Default color is black.',
            'type'        => 'colorpicker',
            'section'     => 'ut_blog_settings',
            'subsection'  => 'ut_blog_overlay_settings',
            'required'      => array(
                'ut_blog_hero_global_styling'       => 'off',
                'ut_blog_overlay_effect'            => 'on',
                'ut_blog_overlay_effect_style'      => 'pipeline|coalesce|shift'
            )
        ),

        array(
            'id'            => 'ut_blog_overlay_effect_color_range',
            'label'         => 'Overlay Effect Color Range',
            ...
            'required' => array(
                'ut_blog_overlay_effect' => 'on',
                'ut_blog_overlay_effect_style' => 'pipeline|coalesce|shift|swirl|aurora'
            )
        ),
