...
/* WPML / POLYLANG */
define( 'UT_TRANSLATE_STRINGS', function_exists('icl_t') );
...
class UT_Loader {
   ...
   /**
	...
	public function define_theme_hooks() {
		...
		$this->loader->add_action( 'init', $this, 'remove_global_css' ); // remove global css
	...
	private function define_admin_hooks() {
	    ...
	    if( is_admin() ) {
            ...
            $cf7_designer = new UT_CF7_Designer();

            $this->loader->add_action( 'wp_ajax_save_cf7_design', $cf7_designer, 'ajax_save_design' );
            $this->loader->add_action( 'wp_ajax_delete_cf7_design', $cf7_designer, 'ajax_delete_design' );
	...
	private function admin_includes() {
		...
		$files = apply_filters( 'unite_admin_includes', array( 
            ...
            'unite-contact-form7-designer.class',
            'unite-license.class',
            'unite-update.class',
			'unite-video.class',
		) );
