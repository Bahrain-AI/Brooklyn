...
class UT_Adaptive_Image {
	...
	public static function create_placeholder( $placeholder = 'blog' ) {
	    ...
	    $image = array(
            'blog' => ot_get_option('ut_global_blog_featured_image', THEME_WEB_ROOT . '/images/placeholder/blog-placeholder-image.jpg' )
        );
        ...
        return '<img src="' . self::create_responsive_placeholder_svg( 750, 625 ) . '" width="750" height="625" data-src="' . $image[$placeholder] . '" class="ut-adaptive-image skip-lazy wp-post-image"> ';
