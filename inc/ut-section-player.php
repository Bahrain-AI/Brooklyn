        ...
        if( $selfhosted )  {
            ...
            if( !empty($mp4) || !empty($ogg) || !empty($webm) ) :
	            ...
	            return $video->handle_shortcode( array(
		            ...
		            'volume'                => $volume,
		            'preload'               => $preload,
                    'video_filter'          => ut_return_hero_config( 'ut_video_filter' ),
		            'video_filter_action'   => 'none',
		            'contrast'              => ut_return_hero_config( 'ut_video_filter_contrast' ),
		            'brightness'            => ut_return_hero_config( 'ut_video_filter_brightness' ),
		            'saturate'              => ut_return_hero_config( 'ut_video_filter_saturate' ),
		            'grayscale'             => ut_return_hero_config( 'ut_video_filter_grayscale' ),
		            'blur'                  => ut_return_hero_config( 'ut_video_filter_blur' ),
		            'sepia'                 => ut_return_hero_config( 'ut_video_filter_sepia' ),
		            'hue'                   => ut_return_hero_config( 'ut_video_filter_hue' ),
		            'invert'                => ut_return_hero_config( 'ut_video_filter_invert' ),
	            ) );
