        ...
        if( $item->object == "megamenu-button" ) {
            ...
            if( class_exists("UT_BTN") ) {
                ...
                $item_output = $button->ut_create_shortcode( array(
                    'button_text'               => $title,
                    'button_text_color'         => $item->megamenu_button_text_color ?? '#FFF',
                    'button_text_color_hover'   => $item->megamenu_button_text_color_hover ?? $megamenu_button_text_color_hover,
                    'button_background'         => $item->megamenu_button_background_color ?? $megamenu_button_background_color,
                    'button_background_hover'   => $item->megamenu_button_background_color_hover ?? $megamenu_button_background_color_hover,
                    ...
                    'button_plain_link'         => $item->megamenu_button_link ?? '',
                    'button_plain_target'       => $item->megamenu_button_link_target ?? '_blank',
                    'button_custom_border'      => $item->megamenu_button_border ?? 'no',
                    'button_border_color'       => $item->megamenu_button_border_color ?? '',
                    'button_border_color_hover' => $item->megamenu_button_border_color_hover ?? '',
                    'button_border_width'       => $item->megamenu_button_border_width ?? '',
                    'button_border_style'       => $item->megamenu_button_border_style ?? '',
                    'spacing'                   => $spacing,
