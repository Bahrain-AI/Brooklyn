            ...
            if( ut_page_option( 'ut_top_header', 'hide' ) == 'show' ) {
                ...
                if( ut_return_header_config( 'ut_top_header_border_bottom', 'off' ) == 'on' ) {
                    ...
                    if( !empty( $ut_top_header_border_bottom_style['border-bottom-style'] ) && $ut_top_header_border_bottom_style['border-bottom-style'] != 'none' ) {
                        ...
                        $top_header += (int)$ut_top_header_border_bottom_style['border-bottom-width'];
		...
		public function wpml_language_switch_top_header() {
            ...
            if ( !empty( $languages ) ) {
                ...
                foreach( $languages as $language ) {
                    ...
                    $code = $language['code'] ?? '';
                    $code = $language['language_code'] ?? $code;

                    $name = $language['native_name'] ?? '';
                    $name = !empty( $language['translated_name'] ) ? $language['translated_name'] : $name;

                    if ( $language['active'] ) {
                            
                        echo '<a class="ut-wpml-language-switch-active" href="' . esc_url( $language['url'] ) . '"><img class="ut-wpml-language-switch-flag" src="' . esc_url( $language['country_flag_url'] ) . '" alt="' . esc_attr( $code ) . '" />';

                            echo '<span class="ut-wpml-language-switch-name hide-on-tablet hide-on-mobile">' . $name . '</span><span class="ut-wpml-language-switch-code hide-on-tablet hide-on-mobile">(' . $code . ')</span>';
                            ...
                            foreach( $languages as $language ) {
                                ...
                                if ( !$language['active'] ) {
                                    ...
                                    echo '<li>';
                                        ...
                                        echo '<a href="' . esc_url( $language['url'] ) . '"><img class="ut-wpml-language-switch-flag" src="' . esc_url( $language['country_flag_url'] ) . '" alt="' . esc_attr( $code ) . '" />';

                                            echo '<span class="ut-wpml-language-switch-name">' . $name . '</span><span class="ut-wpml-language-switch-code">(' . $code . ')</span>';
            ...
            if ( !empty( $languages ) ) {
                ...
                foreach( $languages as $language ) {
                    ...
                    if ( $language['active'] ) {
                        ...
                        echo '<a class="ut-main-navigation-link ut-wpml-language-switch-active" href="' . esc_url( $language['url'] ) . '"><img class="ut-wpml-language-switch-flag" src="' . esc_url( $language['country_flag_url'] ) . '" alt="' . esc_attr( $code ) . '" />';

                            echo '<span class="ut-header-remove-text">' . $name . '</span><span class="ut-wpml-language-switch-code hide-on-tablet hide-on-mobile">(' . $code . ')</span>';
                                    ...
                                    if ( !$language['active'] ) {
                                        ...
                                        echo '<li>';
                                            ...
                                            echo '<a href="' . esc_url( $language['url'] ) . '"><img class="ut-wpml-language-switch-flag" src="' . esc_url( $language['country_flag_url'] ) . '" alt="' . esc_attr( $code ) . '" />';
                                                ...
                                                echo '<span><span class="ut-wpml-language-switch-name">' . $name . '</span><span class="ut-wpml-language-switch-code">(' . $code . ')</span></span>';
