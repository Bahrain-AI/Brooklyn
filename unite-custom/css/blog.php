        ...
        public function custom_css() {
            ...
            <?php if( ot_get_option("ut_blog_overview_date_color") ) : ?>
                ...
                if( !ot_get_option("ut_global_post_meta_date_color") ) {
                    ...
                    if( !ot_get_option("ut_global_post_meta_background") && !( ot_get_option("ut_blog_overview_date_color") == '#FFF' || ot_get_option("ut_blog_overview_date_color") == '#FFFFFF' || ( isset( $ut_blog_overview_date_color ) && $ut_blog_overview_date_color['r'] == 255 && $ut_blog_overview_date_color['g'] == 255 && $ut_blog_overview_date_color['b'] == 255 ) ) ) : ?>
