...
function _ut_front_hero_config( $config ) {
    ...
    $config = array_merge( array(
        ...
        'ut_hero_overlay_effect_background_color'  => 'ut_front_page_overlay_effect_background_color',
        'ut_hero_overlay_effect_color_range'       => 'ut_front_page_overlay_effect_color_range',
